...
`geom_topo()` creates a topographical plot as a `ggplot2` object. This
function automatically combines a number of distinct geom\_\* and
stat\_\* functions to create a default topographical scalp map. Since
geom_raster does not allow unevenly spaced grids, the function creates
