...
* `chan_info`
    + Often NULL on import, since BDF and CNT do not contain (useable) electrode locations. 
...
`eeg_ICA` objects contain the results of an ICA decomposition applied to an `eeg_epochs` object.
