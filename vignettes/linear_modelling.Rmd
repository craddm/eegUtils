...
Here we show how to fit a linear model to single subject's data. We'll use the data from the LIMO EEG dataset. [S1](https://datashare.is.ed.ac.uk/handle/10283/2189?show=full)
